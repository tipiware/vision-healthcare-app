    ...
    <footer class="text-white body-font bg-green-500">
      <div class="container px-5 py-24 mx-auto flex md:items-center lg:items-start md:flex-row md:flex-nowrap flex-wrap flex-col">
        <div class="w-64 flex-shrink-0 md:mx-0 mx-auto text-center">
          <Link legacyBehavior href="/">
            <a class="flex title-font font-medium items-center justify-center text-white mb-4 md:mb-0">
              <a class="ml-3 text-2xl font-bold">Clear vision for all</a>
            </a>
          </Link>
          <p class="mt-3 ml-3 text-sm text-white">
          The objective of Retinal detachment awareness campaign is to raise awareness among general public on the possible symptons and remedy to retinal detachment.
        ...
        <div class="flex-grow flex flex-wrap md:pl-20 -mb-10 md:mt-0 mt-10 md:text-left ">
          <div class="lg:w-1/2 md:w-1/2 w-full px-4  text-center">
